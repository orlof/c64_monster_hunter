...
TYPE Joystick
    ...
    FUNCTION East AS BYTE() STATIC
        IF (THIS.Value AND JOY_RIGHT) = 0 THEN RETURN TRUE
        RETURN FALSE
    END FUNCTION

    FUNCTION West AS BYTE() STATIC
        IF (THIS.Value AND JOY_LEFT) = 0 THEN RETURN TRUE
        RETURN FALSE
    END FUNCTION
    ...
    FUNCTION XAxis AS INT() STATIC
        IF THIS.West() = TRUE THEN RETURN -1
        IF THIS.East() = TRUE THEN RETURN 1
        RETURN 0
    END FUNCTION
