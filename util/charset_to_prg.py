...
chars = bytes([
    ...
    0x83, 0x39, 0x39, 0x01, 0x39, 0x39, 0x39, 0xFF,
    ...
    0x40, 0x14, 0x04, 0x3F, 0xD7, 0xFD, 0xEB, 0xEB,
    0x11, 0x04, 0x10, 0xFC, 0xD7, 0x7F, 0xEB, 0xEB,
    0x10, 0x10, 0x04, 0x3F, 0x17, 0xFD, 0xEB, 0xEB,
    0x04, 0x04, 0x10, 0xFC, 0xD4, 0x7F, 0xEB, 0xEB,
    ...
    0xFF, 0xFD, 0xF6, 0x37, 0x3F, 0x07, 0x10, 0x44,
    0xFF, 0x7F, 0x9F, 0xDC, 0xFC, 0xD0, 0x04, 0x11,
    0xFF, 0xFD, 0xF5, 0xF6, 0x3E, 0x07, 0x10, 0x10,
    0xFF, 0x7F, 0x5F, 0x9F, 0xBC, 0xD0, 0x04, 0x04,
    ...
    0x44, 0x10, 0x04, 0x3F, 0xD7, 0xFD, 0xEB, 0xEB,
    ...
    0x00, 0x00, 0xC0, 0xCC, 0xCC, 0x30, 0x30, 0x00,
    0x00, 0x00, 0xC8, 0xCC, 0xCC, 0x3A, 0xBA, 0x28,
    0x00, 0x00, 0xC8, 0xE8, 0xAA, 0x2A, 0xAA, 0x28,
    0x08, 0x28, 0xAA, 0xAA, 0xAA, 0x2A, 0xAA, 0x28,
    0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA,
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x08, 0x20, 0x28, 0x28, 0x88, 0x00, 0x00,
    0x00, 0x28, 0xA2, 0x2A, 0x28, 0x8A, 0x22, 0x08,
    0x28, 0x2A, 0xAA, 0x2A, 0xA8, 0xAA, 0x2A, 0x28,
    0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA,
    ...
    0x00, 0x00, 0x00, 0x0C, 0xCC, 0x30, 0x30, 0x00,
...
data = bytes((address % 256, address // 256)) + chars
with open("data/charset.prg", "wb") as output_file:
